  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">About This Boilerplate</h1>
        <p className="text-xl text-gray-600">
          A comprehensive React TypeScript starter template with modern best practices.
        </p>
      </div>
